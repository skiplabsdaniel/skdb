...
export interface Mapper<
  K1 extends Json,
  V1 extends Data | Json,
  K2 extends Json,
  V2 extends Data | Json,
> {
  /**
 ...
 */
export interface Reducer<V extends Data | Json, A extends Json> {
  /**
 ...
 * @typeParam V - Type of values.
 */
export interface EagerCollection<K extends Json, V extends Data | Json>
  extends Managed {
  /**
   ...
   */
  map<K2 extends Json, V2 extends Data | Json, Params extends DepSafe[]>(
